...
<html>
<head>
    <title><fmt:message key="title.delete_user_list"/> </title>
...
<div class="table_custom">
    <div class="search_div">
        <form action="${pageContext.request.contextPath}/controller" method="post">
            ...
            <button type="submit" name="command" value="search_delete_user_by_name" align="left" class="fa fa-search"></button>
        </form>
    </div>
    <table align="center">
        <thead>
        ...
        <c:forEach var="user_list" items="${user_list}">
            ...
            <tr>
                ...
                <td>
                    <form action="${pageContext.request.contextPath}/controller" method="post">
                        <button type="submit" class="button long_button" name="command" value="active_user"><fmt:message key="button.restore"/> </button>
