...
<div class="table">
    <table>
        ...
        <tr>
            ...
            <th><fmt:message key="label.product.change_function"/> </th>
            <th></th>
        </tr>
        </thead>
            ...
            <tr>
                ...
                <td>
                    <form action="controller" method="post">
                        <button type="submit" name="command" value="restore_product">restore</button>
                        <input type="hidden" name="product_id" value="${product_list.id}">
                    </form>
                </td>
                <td>
                    <form action="controller" method="post">
                        <button type="submit" name="command" value="really_delete_product">delete</button>
                        <input type="hidden" name="product_id" value="${product_list.id}">
                    </form>
                </td>
            </tr>
